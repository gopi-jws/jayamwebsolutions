      ...
      <nav class="nav">
        <div class="nav__data">
          ...
          <div class="nav__toggle" id="nav-toggle">
            ...
            ></i>
            <i
              class="ri-close-line nav__toggle-close"
              style="margin-left: 100px"
            ></i>
          </div>
        </div>
                ...
                <div class="dropdown__content">
                    ...
                    <ul class="dropdown__list">
                      <li>
                        <a href="#" class="dropdown__link"
                          >Full Featured eCommerce Web development</a
                        >
                      </li>
                      <li>
                        <a href="#" class="dropdown__link"
                          >Simple eCommerce Web development</a
                        >
                      </li>
                      <li>
                        <a href="#" class="dropdown__link"
                  ...
                  <div class="dropdown__group">
                    ...
                    <ul class="dropdown__list">
                      <li>
                        <a href="#" class="dropdown__link"
                          >Business email hosting</a
                        >
                      </li>
                      <li>
                        <a href="#" class="dropdown__link"
                          >Enterprise email hosting</a
                        >
                      </li>
                      <li>
                  ...
                  <div class="dropdown__group">
                    ...
                    <ul class="dropdown__list">
                      <li>
                        <a href="#" class="dropdown__link"
                          >New Domain Name Registration</a
                        >
                      </li>
                      <li>
